...
def detailTodo(cb=None):
    ...
    tk.Label(win, state = "disabled", textvariable= judul).grid(row=1, column=1, sticky= "E")
...
treev.grid(row=0, column=1, sticky='WNS', rowspan=4, columnspan=2)
...
btnAdd = tk.Button(root, text= "Hapus", width = 20, bg= "PeachPuff3", fg= "black", command= delTodo)
btnAdd.grid(row=4, column=2, sticky="N")
btnAdd = tk.Button(root, text= "Load", width = 20, bg= "PeachPuff3", fg= "black", command= LoadTodos)
btnAdd.grid(row=5, column=1, sticky="s")
btnAdd = tk.Button(root, text= "Save", width = 20, bg= "PeachPuff3", fg= "black", command= SaveTodos)
btnAdd.grid(row=5, column=2, sticky="s")
title()
root.mainloop()